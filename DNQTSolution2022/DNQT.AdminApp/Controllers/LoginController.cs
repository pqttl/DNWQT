...
namespace DNQT.AdminApp.Controllers
{
    public class LoginController : Controller
    {
        ...
        [HttpPost]
        public async Task<IActionResult> Index(LoginRequest_ViewModel mRequest)
        {
            ...
            return RedirectToAction(nameof(StatisticController.Index), strController);
        }
                ...
                if (dtOutput != null)
                {
                    ...
                    if (intSumRow > 0)
                    {
                        ...
                        try
                        {
                            ...
                            strPhienBanHanCuoi = $"(Bạn đang sử dụng phiên bản {dtEnd.ToString("HH:mm:ss dd/MM/yyyy")})";
